...
@Component({
  ...
  template: `
    <div class="bg-background min-h-screen">
      <!-- Header -->
      <header class="border-border sticky top-0 z-50 border-b bg-[#0d1117]">
      ...
      <main class="mx-auto max-w-[1280px] px-6 py-6">
        ...
        <!-- Filters -->
        <div class="mb-4 flex flex-wrap items-center gap-4 text-[13px] text-[#8b949e]">
          <span>
            Spoken Language:
            <button class="ml-1 font-semibold text-white hover:underline">Any</button>
          </span>
          <span>
            Language:
            <button class="ml-1 font-semibold text-white hover:underline">Any</button>
          ...
          <span>
            Date range:
            <button class="ml-1 font-semibold text-white hover:underline">Today</button>
          </span>
        </div>
        ...
        @if (activeTab() === 'developers') {
          <div class="border border-[#21262d] px-6 py-12 text-center">
            <p class="text-muted-foreground text-[14px]">Em breve</p>
          </div>
        }
      </main>
