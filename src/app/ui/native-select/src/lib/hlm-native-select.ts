...
export class HlmNativeSelect implements ControlValueAccessor {
  ...
  protected readonly _computedSelectIconClass = computed(() =>
    hlm(
      'text-muted-foreground pointer-events-none absolute end-2.5 top-1/2 -translate-y-1/2 text-[calc(var(--spacing)*4)] select-none',
