...
export class HlmDropdownMenuRadioIndicator {
  constructor() {
    classes(
      () =>
        'pointer-events-none absolute end-2 flex items-center justify-center opacity-0 group-data-checked/dropdown-menu-radio:opacity-100 [&_ng-icon]:text-[calc(var(--spacing)*4)]',
    );
  }
}
